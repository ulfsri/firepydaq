...
class check_system_config():
    ...
    def __init__(self):
        ...
        for device in system.devices:
            ...
            self.AOChans[device.name] = [chan.name.split('/')[1] for chan in device.ao_physical_chans]
            n+=1
    ...
    def GetCleanInfo(self, Devs, Chans):
        ...
        Devs = {key:Devs[key] for n,key in enumerate(Devs.keys()) if chassis_locs[n]}
        Devs_names = [val for n,val in enumerate(Devs_names) if chassis_locs[n]]
